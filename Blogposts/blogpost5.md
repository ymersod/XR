...
### Game Tester (Simon Sohn)

In the development of the vr project I've primarily functioned as the play tester. In simple terms that means the level design shown in Level design has primarily been me getting dizzy in vr and giving my feedback. When we meet a bog, I would try and recreate it so Simon and Merethe could research how it happened in the editor.

Other than that we found that it was pretty fun to simply climb the mountain directly, instead of using the platforms.
...
Did some final touch ups one the multiplayer in AR project. Now the real winner is shown as the winner on both screens.
Other than that we did some final touches on the game feel for the android phones in class(as the feel on our modern iphones were different).
