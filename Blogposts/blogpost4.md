...
### Task 1: Healthbar implementation on schoolmons and quiz logic (Merethe)
...
##### An update
So the logic for the fighting was done, but now it should be updated, so it could fit the multiplayer networking. This was done together with Simon Sohn. 
